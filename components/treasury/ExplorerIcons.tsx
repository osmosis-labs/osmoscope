// Inlined block-explorer logos for the treasury holder links. Inlined (not
// <img src>) so there's no external request and they work under a strict CSP.
import type { SVGProps } from "react";

// Etherscan mark only (the diamond), cropped from the official light wordmark
// (etherscan.io/assets/svg/logos/logo-etherscan-light.svg) to just the icon so
// it sits as a square next to the Mintscan mark. Uses currentColor for the two
// white glyph paths; the small accent path keeps its original grey.
export function EtherscanMark(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      viewBox="0 0 122 122"
      fill="none"
...
// Cosmostation / Mintscan logo (colored), from
// github.com/cosmostation/logo. Trimmed to the mark paths; keeps its brand
// purple + teal.
export function MintscanMark(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      ...
      {...props}
    >
      <g transform="translate(78.491 115.866)">
        <path
