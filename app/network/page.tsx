...
export default function StakingPage() {
  return (
    <main className="min-h-screen overflow-x-hidden bg-gradient-to-br from-osmo-900 via-osmo-800 to-osmo-900 p-4 sm:p-8">
      <div className="mx-auto max-w-7xl">
        <SiteHeader subtitle="Network" current="/network" />
        <StakingView />
      </div>
    </main>
  );
