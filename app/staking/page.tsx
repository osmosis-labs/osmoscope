...
const TITLE = "OSMOscope: Staking";
const DESCRIPTION =
  "Osmosis staking and decentralization: the Nakamoto and Gini coefficients, voting-power distribution, the validator set, pending undelegations, and validator performance.";
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-osmo-900 via-osmo-800 to-osmo-900 p-4 sm:p-8">
      <div className="mx-auto max-w-7xl">
        <SiteHeader subtitle="Staking" current="/staking" />
        <StakingView />
      </div>
    </main>
  );
